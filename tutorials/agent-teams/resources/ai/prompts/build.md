...
6. **Stop for approval:** Run the documented tests and present the final diff, test results, known limitations, and any remaining findings. Do not commit, push, merge, or deploy until a human reviews that evidence and gives explicit approval.
