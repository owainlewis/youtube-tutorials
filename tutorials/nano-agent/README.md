...
- Supporting files - [`ARCHITECTURE.md`](./ARCHITECTURE.md), [`REQUIREMENTS.md`](./REQUIREMENTS.md), [`TASKS.md`](./TASKS.md), [`TODO.md`](./TODO.md), [`nano-agent.example.yml`](./nano-agent.example.yml), [`pyproject.toml`](./pyproject.toml).
