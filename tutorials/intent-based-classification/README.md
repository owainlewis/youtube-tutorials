...
Most RAG systems send every query through the same pipeline. That's wasteful - different queries need different retrieval strategies. A conceptual question needs broad semantic search. A factual question needs a database lookup. An...
...
- Supporting files - [`pyproject.toml`](./pyproject.toml).
