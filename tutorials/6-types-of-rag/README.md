...
- Explore code samples: [src](./src/), [sql](./sql/), [data](./data/)
- Open slides or visual assets: [SLIDES.html](./SLIDES.html)

## What's Inside

- `lesson.md` - the main teaching document.
- Code folders - runnable examples, demo apps, SQL, Terraform, or sample tools.
- Supporting files - [`ARCHITECTURE.md`](./ARCHITECTURE.md), [`SLIDES.html`](./SLIDES.html), [`WALKTHROUGH.md`](./WALKTHROUGH.md), [`docker-compose.yml`](./docker-compose.yml), [`pyproject.toml`](./pyproject.toml).
